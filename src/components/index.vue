          ...
          <div class="row mb-2">
            <div class="col-md-7">
              <div class="card border-0 flex-md-row box-shadow h-md-250">
                ...
                <img class="card-img-right flex-auto d-none d-md-block" data-src="holder.js/200x250?theme=thumb" alt="Thumbnail [200x250]" src="../../static/img/index/study_computer_img1.png" data-holder-rendered="true">
              </div>
            </div>
            <div class="col-md-5">
              <div class="card border-0 flex-md-row box-shadow h-md-250">
                ...
                <img class="card-img-right flex-auto d-none d-md-block mt-5" data-src="holder.js/200x250?theme=thumb" alt="Thumbnail [200x250]" src="../../static/img/index/study_computer_img2.png" data-holder-rendered="true">
              </div>
            </div>
          </div>
          <div class="row mb-2">
            <div class="col-md-5">
              <div class="card border-0 flex-md-row box-shadow h-md-250">
                ...
                <img class="card-img-right flex-auto d-none d-md-block mt-5" data-src="holder.js/200x250?theme=thumb" alt="Thumbnail [200x250]"src="../../static/img/index/study_computer_img3.png" data-holder-rendered="true">
              </div>
            </div>
            <div class="col-md-7">
              <div class="row pr-3">
                <div class="col-md-4 p-0 pl-2">
                  <div class="card border-0 text-center">
                    <img class="card-img-top" src="../../static/img/index/study_computer_img4.png" alt="Card image cap">
                ...
                <div class="col-md-4 p-0 pl-2">
                  <div class="card border-0 text-center">
                    <img class="card-img-top" src="../../static/img/index/study_computer_img5.png" alt="Card image cap">
                    <div class="card-body p-0 pr-1 pl-1">
...
<script>
  ...
  export default {
    ...
    data () {
      return {
        pics:[
            "../../static/img/index/banner1.png",
            "../../static/img/index/banner2.png",
            "../../static/img/index/banner3.png",
            "../../static/img/index/banner4.png",
        ]
      }
    }
  }
